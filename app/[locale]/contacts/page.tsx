        ...
        {channels.map((channel) => (
          <article key={channel.type} className="card-layered space-y-2">
            ...
            {channel.type === 'email' ? (
              ...
              <p className="text-sm text-neutral-600 flex items-center gap-3">
                <a href="tg://resolve?phone=380667213166">
                  <BrandIcon brand="telegram" className="inline-block align-[-2px]" />
                  <span className="sr-only">Telegram</span>
                </a>
                <span className="opacity-40">·</span>
                <a href="https://wa.me/380667213166">
                  <BrandIcon brand="whatsapp" className="inline-block align-[-2px]" />
                  <span className="sr-only">WhatsApp</span>
                </a>
                <span className="opacity-40">·</span>
                <a href="viber://chat?number=%2B380667213166">
                  <BrandIcon brand="viber" className="inline-block align-[-2px]" />
              ...
              (() => {
                ...
                return (
                  <div className="space-y-1 text-sm text-neutral-600">
                    ...
                    <p>
                      <a href={rep.shop.url} target="_blank" rel="noopener noreferrer" className="text-brand underline">
                        {rep.shop.label}
                      </a>
                    </p>
                  </div>
