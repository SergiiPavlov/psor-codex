...
export async function generateMetadata({params}: {params: {locale: Locale}}) {
  ...
  const page = tLegal.raw('delivery') as {title: string; intro: string}
  return {
...
export default async function DeliveryPage({params}: {params: {locale: Locale}}) {
  ...
  const page = tLegal.raw('delivery') as {title: string; intro: string; sections: Array<{title: string; body: string}>}
