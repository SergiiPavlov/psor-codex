...
export async function generateMetadata({params}: {params: {locale: Locale}}) {
  ...
  const page = tLegal.raw('privacy') as {title: string; intro: string}
  return {
...
export default async function PrivacyPage({params}: {params: {locale: Locale}}) {
  ...
  const page = tLegal.raw('privacy') as {title: string; intro: string; sections: Array<{title: string; body: string}>}
