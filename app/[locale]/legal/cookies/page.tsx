...
export async function generateMetadata({params}: {params: {locale: Locale}}) {
  ...
  const page = tLegal.raw('cookies') as {title: string; intro: string}
  return {
...
export default async function CookiesPage({params}: {params: {locale: Locale}}) {
  ...
  const page = tLegal.raw('cookies') as {title: string; intro: string; sections: Array<{title: string; body: string}>}
