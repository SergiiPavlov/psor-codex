...
export async function generateMetadata({params}: {params: {locale: Locale}}) {
  ...
  const page = tLegal.raw('returns') as {title: string; intro: string}
  return {
...
export default async function ReturnsPage({params}: {params: {locale: Locale}}) {
  ...
  const page = tLegal.raw('returns') as {title: string; intro: string; sections: Array<{title: string; body: string}>}
